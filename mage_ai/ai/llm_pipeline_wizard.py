...
from mage_ai.settings import ENABLE_HUGGING_FACE, ENABLE_OPEN_AI, ENABLE_OPEN_AI_COMPATIBLE
    ...
    def __init__(self):
        ...
        if ENABLE_OPEN_AI and ai_config.mode == AIMode.OPEN_AI:
            ...
            raise Exception('AI Mode is not available. ENABLE_OPEN_AI: '
                            f'{ENABLE_OPEN_AI}, ENABLE_OPEN_AI_COMPATIBLE: '
                            f'{ENABLE_OPEN_AI_COMPATIBLE}, ENABLE_HUGGING_FACE: '
                            f'{ENABLE_HUGGING_FACE}')
